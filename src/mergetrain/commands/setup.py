...
_AGENT_RULES = (
    ...
    "Enqueue every named finished branch in the requested order using only its task, branch, and optional worktree; mergetrain captures the exact commits. Stop after the last successful enqueue unless the user explicitly authorized validation or the complete validation-and-deployment workflow.",
